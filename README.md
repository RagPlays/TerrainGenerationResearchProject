...
So now my research project is focused on generating a realistic 2D top-down map. Faking 3D with racasting shadows. (If I had had experience with a 3D engine, I would have considered using it.)
